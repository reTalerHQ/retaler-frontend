...
export const InventorySettings = () => {
    ...
    const hasStockLimitChanges = JSON.stringify(stockAlert) !== JSON.stringify(editedData);
    ...
    return (
        <>
            <div className="flex flex-col justify-between gap-3 lg:flex-col">
                ...
                <div className="flex flex-col justify-between gap-3 lg:flex-col w-full md:max-w-[50vw] md:w-[50vw]">
                        ...
                        <div className="flex flex-col gap-5">
                            <div className="flex flex-row">
                                ...
                                <div className="ml-auto">
                                    <Switch thumbSize="size-5" trackWidth="w-10" trackHeight="h-6" checked={lowStockAlerts} onCheckedChange={setLowStockAlerts} />
                                </div>
                            </div>
                            {lowStockAlerts && (
                                <div className="text-base font-semibold">
                                    <Input 
                                        ...
                                        onChange={e => setEditedData({ ...editedData, lowStock: e.target.value })}
                    ...
                    <section className="flex flex-col gap-4 rounded-xl border bg-white px-4 py-4 w-full">
                        <div className="flex flex-col gap-5">
                            <div className="flex flex-row">
                                <h2 className="text-md font-semibold">
                                ...
                                <div className="ml-auto">
                                    <Switch thumbSize="size-5" trackWidth="w-10" trackHeight="h-6" checked={criticalLowStockAlerts} onCheckedChange={setCriticalLowStockAlerts} />
                                </div>
                            </div>
                            {criticalLowStockAlerts && (
                                <div className="text-base font-semibold">
                                    <Input 
                                        ...
                                        onChange={e => setEditedData({ ...editedData, criticalLowStock: e.target.value })}
                                        onFocus={e => e.target.select()}
                    ...
                    <Button
                        ...
                        onClick={handleSave}
                        className={`w-[140px] min-w-[120px] ${canSave ? 'bg-blue-600 text-white' : 'bg-gray-300 text-gray-700'} self-end mt-4`}
                    >
                        Save Settings
                    </Button>
                </div>
